...
def main():
    ...
    trust_contract._createCompany(
        0, company_account, 2, {"from": owner_account})
    ...
    '''
        Step3: the employer makes a payment to the NativeCompany contract.
    ...
    '''
    # approve anevalent of the amount they are paying
    trust_contract.makePayment({"from": company_account})
    '''
        This transfers the total amount the company is supposed to pay and adds employee address to the IDA index
    '''
