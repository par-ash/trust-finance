			...
			<div className="row bg-primary full_height">
				<div className="col bg-white rounded-end justify-content-center d-flex align-items-center">
					<div className="my-5 w-75">
						<div className="mx-5 px-5">
							...
							<div className="mt-3">
								<div>
									<label htmlFor="fullName" className="form-label fw-semibold">Company Name</label>
								...
								<div>
									<label htmlFor="fullName" className="form-label fw-semibold">Role</label>
									<div className="input-group mb-3">
										<input
											type="text"
											id="fullName"
                    ...
                    I Agree to the terms and conditions
								...
								<div className="text-center mt-3">
									<Link to="/">
										<button type="button" className="btn btn-link">Back to Homepage</button>
									</Link>
								</div>
							</div>
						</div>
				...
				<div className="col">
					<div className="h-100 d-flex justify-content-center align-items-center">
						<img src={LoginBg} height="500" alt="registration" />
					</div>
				</div>
			</div>
		</div>
